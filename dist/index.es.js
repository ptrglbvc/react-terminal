...
var TerminalContext$1 = React.createContext({
    bufferedContent: "",
    temporaryContent: "",
...
var TerminalContextProvider$1 = function (props) {
    ...
    var _b = React.useState(""), temporaryContent = _b[0], setTemporaryContent = _b[1];
    var _c = React.useState([]), commandsHistory = _c[0], setCommandsHistory = _c[1];
    var _d = React.useState(null), historyPointer = _d[0], setHistoryPointer = _d[1];
    React.useEffect(function () {
    ...
    return (React.createElement(TerminalContext$1.Provider, { value: {
...
var useEditorInput = function (consoleFocused, editorInput, setEditorInput, setProcessCurrentLine, caretPosition, setCaretPosition, setBeforeCaretText, setAfterCaretText, enableInput) {
    var _a = React.useContext(TerminalContext$1), getPreviousCommand = _a.getPreviousCommand, getNextCommand = _a.getNextCommand;
    var handleKeyDownEvent = function (event) {
        ...
        else if (eventKey === "Unidentified" && isMobile) {
...
var useBufferedContent = function (processCurrentLine, setProcessCurrentLine, prompt, currentText, setCurrentText, setCaretPosition, setBeforeCaretText, setAfterCaretText, commands, errorMessage, defaultHandler) {
    var _a = React.useContext(TerminalContext$1); _a.bufferedContent; var setBufferedContent = _a.setBufferedContent, setTemporaryContent = _a.setTemporaryContent;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        waiting = (React.createElement(React.Fragment, null,
                            React.createElement("span", { style: { color: themeStyles.themePromptColor } },
                                prompt,
                                " "),
                            React.createElement("span", null, currentText),
                            React.createElement("br", null)));
                        setBufferedContent(function (previous) { return (React.createElement(React.Fragment, null,
                            previous,
                            waiting)); });
                        setCurrentText("");
                        setCaretPosition(0);
                    ...
                    case 8:
                        ...
                        _b.label = 9;
                    case 9:
                        nextBufferedContent = (React.createElement(React.Fragment, null, output ? (React.createElement("span", null,
                            output,
                            React.createElement("br", null))) : null));
                        setBufferedContent(function (previousBufferedContent) { return (React.createElement(React.Fragment, null,
...
var useCurrentLine = function (caret, consoleFocused, prompt, commands, errorMessage, enableInput, defaultHandler, wrapperRef) {
    var style = React.useContext(StyleContext);
    var themeStyles = React.useContext(ThemeContext);
    var _a = React.useContext(TerminalContext$1), appendCommandToHistory = _a.appendCommandToHistory, temporaryContent = _a.temporaryContent;
    var mobileInputRef = React.useRef(null);
    var _b = React.useState(""), editorInput = _b[0], setEditorInput = _b[1];
    var _c = React.useState(false), processCurrentLine = _c[0], setProcessCurrentLine = _c[1];
    var _d = React.useState(0), caretPosition = _d[0], setCaretPosition = _d[1];
    var _e = React.useState(""), beforeCaretText = _e[0], setBeforeCaretText = _e[1];
    var _f = React.useState(""), afterCaretText = _f[0], setAfterCaretText = _f[1];
    React.useEffect(function () {
        if (!isMobile) {
            return;
        }
    ...
    var mobileInput = isMobile && enableInput ? (React.createElement("div", { className: style.mobileInput },
        React.createElement("input", { type: "text", autoComplete: "off", autoCorrect: "off", autoCapitalize: "off", spellCheck: "false", value: editorInput, onChange: function (event) { return setEditorInput(event.target.value); }, ref: mobileInputRef, "data-testid": "editor-input" }))) : null;
    var currentLine = !processCurrentLine ? (React.createElement(React.Fragment, null,
        mobileInput,
        React.createElement("span", { style: { color: themeStyles.themePromptColor } }, prompt),
        React.createElement("div", { className: style.lineText },
            React.createElement("span", { className: style.preWhiteSpace }, beforeCaretText),
            ...
            React.createElement("span", { className: style.preWhiteSpace }, afterCaretText)))) : (React.createElement(React.Fragment, null,
        mobileInput,
        React.createElement("div", { className: style.lineText },
            consoleFocused && caret ? ( //if caret isn't true, caret won't be displayed
            React.createElement("span", { className: style.caret },
                React.createElement("span", { className: style.caretAfter, style: { background: themeStyles.themeColor } }))) : null,
            React.createElement("span", { className: style.preWhiteSpace }, temporaryContent))));
...
function Editor(props) {
    ...
    var style = React.useContext(StyleContext);
    var themeStyles = React.useContext(ThemeContext);
    var bufferedContent = React.useContext(TerminalContext$1).bufferedContent;
...
function Terminal(_a) {
    ...
    var wrapperRef = React.useRef(null);
    var _o = React.useState(!isMobile), consoleFocused = _o[0], setConsoleFocused = _o[1];
    var style = React.useContext(StyleContext);
    var themeStyles = React.useContext(ThemeContext);
...
export { ReactTerminal, TerminalContext, TerminalContextProvider, index as default };
